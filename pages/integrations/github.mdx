...
1. [Join the private beta](https://app.sigilix.ai) → authorize OAuth
...
Most orgs install Sigilix on multiple repos. During the private beta there are no per-tier repo caps — repo access is provisioned per account; reach out to [support@sigilix.ai](mailto:support@sigilix.ai) if you want Sigilix on more repos.
...
<Cards>
<Cards.Card title="First Review" href="/getting-started/first-review">
    How to read the first inline Sigilix review on a PR.
  </Cards.Card>
<Cards.Card title="Usage & Limits" href="/usage-limits">
    How PR review usage shares the organization pool.
  </Cards.Card>
<Cards.Card title="Slash Commands" href="/configuration/commands">
    Commands you can run from GitHub comments.
  </Cards.Card>
</Cards>
