...
<Callout type="info">
GitLab support is part of the **private beta**. [Join the private beta](https://app.sigilix.ai) to get your account provisioned. You can also **sign in to the dashboard with GitLab** directly.
</Callout>
