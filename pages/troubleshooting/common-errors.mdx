...
### 5. Did you hit a usage cap?

If the relevant usage pool is exhausted, Sigilix pauses new requests in that window instead of starting more work. Check the portal usage panel for your seat pool and the organization usage view for PR reviews, Linear triage, and Slack. See [Usage & Limits](/usage-limits).
...
The review still posts with the available specialists; Harmonia synthesizes whatever returned. Sigilix doesn't retry the missing specialist on the same SHA — push a new commit to trigger a fresh review.

If a specific specialist is consistently failing, [contact us](mailto:support@sigilix.ai) — there may be an outage at the model provider.
...
This is rare — Sigilix's pre-validation should catch bad positions before submission. If you see it consistently on a particular repo, [contact us](mailto:support@sigilix.ai).
...
If you've rotated the GitHub App's webhook secret, you need to update the secret on the Sigilix deployment side. Reach out to [support@sigilix.ai](mailto:support@sigilix.ai) and we'll re-sync.
...
See [Rules & Guidance](/configuration/rules-and-guidance) for writing effective rules.

## Still stuck?

Email us at [support@sigilix.ai](mailto:support@sigilix.ai) with:
