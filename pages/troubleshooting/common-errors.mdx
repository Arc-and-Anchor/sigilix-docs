...
If a Sigilix review's footer says `_3 of 4 specialists succeeded._`, one of the four domain specialists — logic, security, performance, or tests — failed. This usually means:
...
The review still posts with the available specialists; the synthesizer combines whatever returned. Sigilix doesn't retry the missing specialist on the same SHA — push a new commit to trigger a fresh review.
