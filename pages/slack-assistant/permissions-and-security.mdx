...
<Callout type="info">
The Slack app is installed **per workspace**, and a workspace maps to a single Sigilix tenant. [Get started](https://app.sigilix.ai/login) to install it, and contact <a href="mailto:support@sigilix.ai">support@sigilix.ai</a> for help enabling it for a workspace.
</Callout>
