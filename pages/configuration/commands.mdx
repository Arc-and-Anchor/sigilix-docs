...
| Per-command usage caps | Commands spend from the relevant seat or organization pool. Bursts beyond the active window pause or queue until capacity returns. See [Usage & Limits](/usage-limits). |
