...
Multi-agent review is more expensive than single-agent review. Five model calls per PR cost more than one. Sigilix pricing is per-seat plus usage across the Free, Pro, Teams, Max, and Ultra plans, with bring-your-own-key support on the CLI and chat surfaces — see [pricing](https://sigilix.ai/pricing) for the current shape.
