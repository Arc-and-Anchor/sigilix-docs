...
flowchart TD
    ...
    ensemble["Ensemble review<br/>(four specialists)"]
...
<FeatureCard title="Ensemble review">
    The full four-specialist pass: logic, security, performance, and tests, unified by the synthesizer. This is the deep review.
...
<Callout type="info">
The point of the dispatcher is cost and latency isolation. The expensive work — the four-specialist ensemble running models tuned per role — is reserved for the events that need depth. Everything else takes a path sized to its job.
</Callout>
