...
See the [Synthesizer page](/how-it-works/synthesizer) for the four sub-stages. Harmonia runs a calibration-strong model with a cross-provider fallback. This is where the **grounding gate** runs and each surviving finding earns its [proof-tier receipt](/how-it-works/confidence-scoring).
