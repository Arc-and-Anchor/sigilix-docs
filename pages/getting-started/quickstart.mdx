...
If a finding is a false positive or out of scope, reply to it. You can dismiss it, or teach Sigilix a rule so it stops happening: reply `@sigilix remember <the rule>` and it will apply — and attribute — that rule in later reviews. See [Conversational Learnings](/memory/conversational-learnings).
