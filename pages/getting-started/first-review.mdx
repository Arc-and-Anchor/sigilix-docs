...
<div className="sigilix-review-chrome">
    ...
    <Callout type="info">
      **Sigilix Summary** — the synthesizer synthesized 4 findings across 3 specialists. 1 requires action before merge.
    </Callout>

    <details>
<summary>Security · Security · Critical · VERIFIED</summary>
...
<a href="#" className="sigilix-diff-link">View diff →</a>
      ...
      <details>
<summary>Performance · Performance · Warning · GROUNDED</summary>
...
<a href="#" className="sigilix-diff-link">View diff →</a>
      ...
      <details>
<summary>Tests · Tests · Info · GROUNDED</summary>
...
- **Category** — the area within that specialist's domain (e.g., Security · Security)
