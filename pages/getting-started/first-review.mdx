...
- Teach a rule — `@sigilix remember we use integer cents here` — which Sigilix records and applies, with inline attribution, in later reviews (`@sigilix forget …` walks it back). See [Conversational Learnings](/memory/conversational-learnings).
