...
<Frame>
  <div className="sigilix-review-chrome">
    ...
    <AccordionGroup>
      ...
      <Accordion title="Pulse · Performance · Warning">
...
- **Specialist tag** — Glyph, Warden, Pulse, Weave (Core never posts inline findings — it only synthesizes)
...
- Re-runs the deterministic-checks layer and the four specialists incrementally on the changed lines (carrying forward findings on unchanged lines per ARC-194)
