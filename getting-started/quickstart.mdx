...
If you need to tune behavior — disable a specialist, ignore generated files, change the rate-limit window — drop a `sigilix.yaml` at the root of your repo. See [Configuration](/configuration/sigilix-yaml) for the full schema.
