...
Sigilix is distributed as a [GitHub App](https://docs.github.com/en/apps/using-github-apps/about-using-github-apps). This page details what permissions it requests, why, and how to scope its access.
...
## OAuth scopes (for /signup)

When you sign in at [sigilix.ai/signup](https://sigilix.ai/signup), the OAuth flow requests:
...
For full data handling details, see [Data & Privacy in the Marketing Site Trust page](https://sigilix.ai/security) (coming soon — pre-revenue placeholder).
