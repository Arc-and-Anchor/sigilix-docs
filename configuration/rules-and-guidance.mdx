...
|---|---|---|
| `logic` | Athena | Architecture, layering, dependency rules, dead code |
| `security` | Argus | Auth boundaries, input validation, secret leakage |
| `performance` | Hermes | N+1, hot paths, memory, big-O regressions |
| `tests` | Themis | Naming, semantics, test coverage, branch reachability |
