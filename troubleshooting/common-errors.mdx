...
If a specific specialist is consistently failing, [contact us](mailto:hello@sigilix.ai) — there may be a regional outage at the model provider.
...
This is rare — Sigilix's pre-validation should catch bad positions before submission. If you see it consistently on a particular repo, [contact us](mailto:hello@sigilix.ai).
...
If you've rotated the GitHub App's webhook secret, you need to update the secret on the Sigilix deployment side. Reach out to [hello@sigilix.ai](mailto:hello@sigilix.ai) and we'll re-sync.
...
Email us at [hello@sigilix.ai](mailto:hello@sigilix.ai) with:
