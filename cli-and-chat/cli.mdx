...
<CardGroup cols={2}>
  <Card title="Same ensemble" icon="diagram-project">
  ...
  <Card title="Same gates" icon="shield-check">
  ...
  <Card title="Same context" icon="layer-group">
  ...
  <Card title="Before the PR" icon="gauge-high">
...
<Steps>
  ...
  <Step title="Run deterministic checks first">
  ...
  <Step title="Fetch earned context">
  ...
  <Step title="Pass the believability gates">
  ...
  <Step title="Synthesize and print">
...
<AccordionGroup>
  <Accordion title="Review before you open the PR">
  ...
  <Accordion title="Review a specific range">
  ...
  <Accordion title="Scope a review with path filters">
  ...
  <Accordion title="Use it in a pre-push hook or CI">
...
<CardGroup cols={2}>
  ...
  <Card title="Command reference" icon="terminal" href="/cli-and-chat/commands">
