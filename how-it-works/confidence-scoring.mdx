...
Between a specialist producing a finding and that finding posting, Zeus runs the **grounding gate**: the finding must be anchored to the code it claims to be about.
...
<CardGroup cols={2}>
  ...
  <Card title="Synthesizer" icon="git-merge" href="/how-it-works/synthesizer">
    How Zeus runs the grounding gate and stamps proof-tier receipts.
  </Card>
</CardGroup>
