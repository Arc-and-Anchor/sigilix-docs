...
<CardGroup cols={2}>
  <Card title="The field's two stages" icon="arrow-right">
  ...
  <Card title="Sigilix's five gates" icon="shield-check">
...
<CardGroup cols={2}>
  <Card title="Review Provenance" icon="fingerprint" href="/evidence-and-provenance/review-provenance">
    Proof-tier receipts and the refute/execute stage in detail.
  </Card>
  <Card title="The Synthesizer" icon="git-merge" href="/how-it-works/synthesizer">
    How Zeus cross-references, calibrates, and renders surviving findings.
  </Card>
</CardGroup>
