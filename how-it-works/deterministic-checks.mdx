...
Sigilix has a **deterministic checks layer** that runs *before* the four domain specialists. Matches surface as authoritative findings that Zeus (the synthesizer) treats as ground truth, not as another opinion to weigh.
