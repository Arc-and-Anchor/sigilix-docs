...
<Steps>
  <Step title="Read the failure, not a vibe">
  ...
  <Step title="Correlate to the diff">
  ...
  <Step title="Post inline, anchored">
...
<AccordionGroup>
  <Accordion title="The failing job's logs">
  ...
  <Accordion title="The diff that triggered the run">
  ...
  <Accordion title="Surrounding code, via the code graph">
